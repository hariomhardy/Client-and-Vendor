...
class DeliveryBoysEditPage extends StatefulWidget {
  final VendorDeliveryBoy deliveryBoy ;
  final Vendor vendor ;
  DeliveryBoysEditPage({Key key  , this.vendor , this.deliveryBoy}) : super(key : key) ;
  @override
  _DeliveryBoysEditPageState createState() => _DeliveryBoysEditPageState();
}

class _DeliveryBoysEditPageState extends State<DeliveryBoysEditPage> {
  ...
  String imageUrl ;
  VendorDeliveryBoy oldDeliveryBoy ;
  ...
  Future<void> saveChanges() async {
    ...
    if (val) {
      ...
      VendorDeliveryBoy newDeliveryBoy = new VendorDeliveryBoy.custom(name: nameValue , phoneNumber: mobileValue , address: addressObj , emailId: emailValue) ;
      bool val = await updateDeliveryBoy(vendor : widget.vendor , oldDeliveryBoy: oldDeliveryBoy ,
          newDeliveryBoy:  newDeliveryBoy) ;
      if (val == true  && image != null  ) {
        newDeliveryBoy.deliveryBoyId = oldDeliveryBoy.deliveryBoyId ;
        await updateImageDeliveryBoy(vendor: widget.vendor , deliveryBoy: newDeliveryBoy , image: image ) ;
      }
      if (val) {
        CoolAlert.show(
            context: context,
        ...
        CoolAlert.show(
            ...
            text: 'Delivery Boy not Updated ! Please Try Again' ,
            onConfirmBtnTap: () {
              Navigator.pop(context) ;
            }
        );
  ...
  Widget build(BuildContext context) {
    name.text = widget.deliveryBoy.name ;
    email.text = widget.deliveryBoy.emailId ;
    mobile.text = widget.deliveryBoy.phoneNumber ;
    address.text = widget.deliveryBoy.address.description ;
    imageUrl = widget.deliveryBoy.image ;
    oldDeliveryBoy = widget.deliveryBoy ;
    return Scaffold(
      appBar: AppBar(
